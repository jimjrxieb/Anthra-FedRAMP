...
This folder contains "Copy-and-Paste" style templates for implementing FedRAMP Moderate security controls (NIST 800-53 Rev 5). Use these to ensure your application meets the GuidePoint Security hardening standards.
...
*Powered by GuidePoint Security - Iron Legion Platform*
