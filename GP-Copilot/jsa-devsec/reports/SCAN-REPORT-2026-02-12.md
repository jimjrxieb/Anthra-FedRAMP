# JSA-DevSec Scan Report: Anthra-FedRAMP
...
JSA-DevSec performed a comprehensive pre-deployment security scan of the Anthra Security Platform codebase. This represents the **BEFORE** state prior to GuidePoint Security's FedRAMP compliance engagement.
...
### Remaining Work (GuidePoint Consulting)
...
### Follow-Up (GuidePoint Engagement)
...
- **GuidePoint FedRAMP Methodology:** `GP-CONSULTING/07-FedRAMP-Ready/`
